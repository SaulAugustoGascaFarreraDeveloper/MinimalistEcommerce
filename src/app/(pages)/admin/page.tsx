import { CardHeader,Card, CardDescription, CardContent, CardTitle } from '@/components/ui/card'
...
const getUserData = async () => {
    ...
    return {userCount: userCount,averageValuePerUser: userCount === 0 ? 0 : (orderData._sum.pricePaidInCents || 0) / userCount / 100}
}
